...
namespace Pratham_Project_Sem_5
{
    public partial class Clientform : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "insert into Client values(" + textBox1.Text + ",'" + textBox2.Text + "'," + textBox3.Text + ",'" + textBox4.Text + "','" + textBox5.Text + "','" + comboBox1.Text + "')";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            da = new SqlDataAdapter("select * from Client where name like'" + textBox6.Text + "%'", con);
            da.Fill(dt);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "")
            {
                string sql2 = "update Client set name='" + textBox2.Text + "',mobile=" + textBox3.Text + ",email='" + textBox4.Text + "' ,city='" + textBox5.Text + "', category='" + comboBox1.Text + "'where id=" + textBox1.Text + "";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                string sql1 = "delete from Client where id=" + textBox1.Text + "";
        ...
        public void GetproductID()
        {
            con.Open();
            string proid;
            string query = "select id from Client order by id Desc";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                SqlCommand cmd = new SqlCommand("Select name,mobile,email,city,category from Client where id=@id", con);
